...
export const SETTINGS_GROUPS: SettingsGroup[] = [
  {
    ...
    fields: [
      { key: "general.platformName", label: "Platform name", type: "text", default: "Safari Hub" },
      {
        ...
        type: "text",
        default: "Kenya",
        help: "Shown in the header, homepage, and browse copy (e.g. Featured across Kenya).",
      },
      { key: "general.supportEmail", label: "Support email", type: "text", default: "support@safarihub.co.ke" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "payments.cardEnabled", label: "Accept card", type: "boolean", default: true },
      {
        ...
        default: "sandbox",
        options: [
          { value: "sandbox", label: "Sandbox (test cards, no real charge)" },
          { value: "manual", label: "Manual review (mark paid in admin later)" },
        ],
        help: "Production card capture needs a PCI-compliant host (Stripe Elements / Pesapal). Sandbox validates Visa test cards locally.",
      },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "booking.autoConfirm", label: "Auto-confirm paid bookings", type: "boolean", default: false },
    ],
  },
  {
    id: "flags",
    ...
    fields: [
      {
        ...
        label: "eTIMS module",
        help: "When on, providers see the fiscal queue. Live KRA API wiring can follow; manual submit works today.",
        type: "boolean",
        default: true,
      },
      {
        ...
        options: [
          ...
          { value: "sandbox", label: "Sandbox (future API)" },
          { value: "live", label: "Live KRA (future API)" },
        ],
      },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "email.fromEmail", label: "From email", type: "text", default: "no-reply@safarihub.co.ke" },
      { key: "email.host", label: "SMTP host", type: "text", default: "", help: "SMTP provider only." },
      { key: "email.port", label: "SMTP port", type: "number", default: 587, min: 1, max: 65535 },
      { key: "email.secure", label: "Use TLS/SSL", type: "boolean", default: true },
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "textarea",
        default: "",
        help: "Leave blank for the default hospitality ecosystem line.",
      },
    ],
  },
];
